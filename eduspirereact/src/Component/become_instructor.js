                            ...
                            <div class="box">
                                ...
                                <form action="javascript:">
                                    <div class="req_demo">
                                        ...
                                        {localStorage.getItem('user_id')!=null && <Link to="/dashboard"><button type="submit" class="btndefault big">Request a demo</button></Link>}
                                        {(localStorage.getItem('user_id')==null || localStorage.getItem('user_id')==0) && <button type="button" class="btndefault big" onClick={()=>{alert('Please create an account')}}>Request a demo</button>}
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="request_demo">
                    <div class="container">
                        <div class="demo_box">
                            ...
                            <div class="button">
                                <Link to="/dashboard"><button type="submit" class="btndefault big">Get Started</button></Link>
                            </div>
                            <div class="fr_pln">
