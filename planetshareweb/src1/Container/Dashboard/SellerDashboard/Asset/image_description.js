...
state={img_data:[],err_result:[],imgs:[],image_id:0,loading:false,loading_msg:'Please Wait',not_found:false,keywords:[],btn_disable:false,category_list:[],license_rights:[],sel_license_rights:[],territory_rights:[],sel_territory_rights:[]}
  componentDidMount()
  {
  ...
  getFormData=()=>{
    axios.post(GETIMAGEVIDEODATA,{
      ...
      if(res.data.success==1)
      {
        ...
        this.setState({img_data:response},function()
      {
...
<span>Price</span>
                                    ...
                                    <div class="asset_video_uploaded">
                                      <div class="gig_t_img"><img src={this.state.img_data.large_thumb} alt="" /></div>
                                    </div>
