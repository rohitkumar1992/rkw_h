...
state={mature_content:0,vid_data:[],err_result:[],imgs:[],imgs1:[],video_id:0,language:[],loading:false,loading_msg:'Please Wait',not_found:false,lang_sel:[],director:[],producer:[],genre:[],cast:[],keywords:[],btn_disable:false,category_list:[],license_rights:[],sel_license_rights:[],territory_rights:[],sel_territory_rights:[]}
  componentDidMount()
  {
  ...
  getFormData=()=>{
    axios.post(GETIMAGEVIDEODATA,{
      ...
      if(res.data.success==1)
      {
        ...
        var langArr=response.language_id.split(',');
        var intArr=[],intlangArr=[];
        for(var i=0; i < strArr.length; i++)
          intArr.push(parseInt(strArr[i]));
        for(var j=0;j<langArr.length;j++)
           intlangArr.push(parseInt(langArr[j]))
        this.setState({vid_data:response,keywords:response.keywords.split(','),mature_content:response.mature_content,
        lang_sel:intlangArr,
        sel_territory_rights:intArr,producer:response.producer.split(','),director:response.director.split(','),
        cast:response.cast.split(','),genre:response.genre.split(','),imgs1:[response.large_thumb]},function()
      {
...
formData.append('seller_id',localStorage.getItem('seller_id'));
    ...
    formData.append('mature_content',mature_content);
     ...
     formData.append('status_tag',this.state.vid_data.status);
                                ...
                                <form class="form_control" onSubmit={this.videoDescSubmit}>
                                    <div class="field_area">
                                        <div class="fields">
                                            ...
                                            <div class="inputbox">
                                                <input type="text"  placeholder="Video Title" name="video_title" Value={vid_data.title} required/>
                                            </div>
                                            <Tooltip>
                                            <div class="text">
                                        ...
                                        <div class="fields">
                                            ...
                                            <div class="inputbox">
                                                <input type="text"  placeholder="Artist name" name="artist_name" Value={vid_data.artist_name} required/>
                                            </div>
                                            <Tooltip>
                                            <div class="text">
                                                <h3>Describe your Gig.</h3>
                                              ...
                                              <div class="inputbox">
                                                  <select class="f" name="category" required>
                                                      <option selected disabled value="">Select Category</option>
                                                          ...
                                                          return(<option value={res.id} selected={vid_data.video_category_id==res.id}>{res.name}</option>)
                                                      })}
                                                  </select>
                                              </div>
                                              <Tooltip>
...
<span>Price</span>
                                            ...
                                            <ul class="browse_list">
                                                <li>
                                                    <div class="upl_box">
                                                      ...
                                                      {(this.state.imgs1 && this.state.imgs) && [...this.state.imgs1].map((file)=>(
                                                      <img src="" id="upload_img"  src={file} alt="" />   ))}
                                    ...
                                    <div class="description">
                                        ...
                                        <div class="disc_box">
                                            ...
                                            <div class="inputbox">
                                                <textarea minlength="30" maxlength="80" name="video_short_desc" required>{vid_data.short_desc}</textarea>
                                                <div class="inf">
                                                  <span>max. 80</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="description">
                                        ...
                                        <div class="disc_box">
                                            ...
                                            <div class="inputbox">
                                                <textarea minlength="80" maxlength="1200" name="video_desc" required>{vid_data.description}</textarea>
                                                <div class="inf">
                                                  <span>min. 120</span>
                                                </div>
                                            </div>
