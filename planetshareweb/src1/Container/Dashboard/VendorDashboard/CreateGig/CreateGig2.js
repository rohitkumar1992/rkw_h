...
{
  state={btn_disable:false,language:[],imgs:[],loading:true,loading_msg:'Please Wait',categories:[],category_id:0,keywords:[],isLoading:false,lang_sel:[]}
  componentDidMount()
  {
...
// }
  ...
  onSubmitForm=(e)=>{
     ...
     {
         toast('Three Gig Photots are mandatory',{ transition: Zoom,});
         return false;
     }
      var gig_upload_1 =this.state.imgs[0];
     var gig_upload_2 = this.state.imgs[1];
     var gig_upload_3 = this.state.imgs[2];
...
render()
{
  const {loading_msg,loading,language,categories,isLoading}=this.state;
