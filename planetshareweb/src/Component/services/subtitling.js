                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="box r">
                                ...
                                <div class="ord_subt">
                                    <Link to="/web/viewall/subtitling/2"><button type="button" class="btn btndefault"><i class="fa fa-rocket"></i> Order Subtitles Now</button></Link>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="inner_cont subt_ser">
                              ...
                              <div class="row">
                                  <div class="col-md-4 col-sm-4">
                                      <div class="box l">
                                          ...
                                          <div class="buttons">
                                              <Link to="/web/viewall/subtitling/2"><button type="button" class="btn btndefault">Order Now</button></Link>
                                          </div>
            ...
            <div class="step_boxes">
                <div class="container">
                    ...
                    <div class="buttons">
                        <Link to="/web/viewall/subtitling/2"><button type="button" class="btn btndefault">Order Subtitles Now</button></Link>
                    </div>
                </div>
            </div>
            ...
            <div class="trans_layout fture">
                <div class="container">
                    ...
                    <div class="buttons">
                        <Link to="/web/viewall/subtitling/2"><button type="button" class="btndefault">Get Started for Free</button></Link>
                    </div>
                </div>
            </div>
        </div>
